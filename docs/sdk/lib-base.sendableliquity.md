...
|  [approveWethTokens(allowance)](./lib-base.sendableliquity.approvewethtokens.md) | Allow the liquidity mining contract to use WETH tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
