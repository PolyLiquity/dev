...
|  [approveWethTokens(allowance, overrides)](./lib-ethers.populatableethersliquity.approvewethtokens.md) |  | Allow the liquidity mining contract to use WETH tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
