...
|  [approveWethTokens(allowance, overrides)](./lib-ethers.sendableethersliquity.approvewethtokens.md) |  | Allow the liquidity mining contract to use WETH tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
