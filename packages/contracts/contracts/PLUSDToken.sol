...
contract PLUSDToken is CheckContract, IPLUSDToken {
    using SafeMath for uint256;
    
    uint256 private _totalSupply;
    string constant internal _NAME = "PLUSD Stablecoin";
    string constant internal _SYMBOL = "PLUSD";
    ...
    function _requireCallerIsBorrowerOperations() internal view {
        require(msg.sender == borrowerOperationsAddress, "PLUSDToken: Caller is not BorrowerOperations");
    }
